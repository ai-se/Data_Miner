    ...
    def getCommitStatsProperties( stats, commitFiles, devExperience, author, unixTimeStamp, _commit_hash):
        ...
        for stat in stats:
            ...
            if(fileName in commitFiles):
                ...
                adev = getattr(prevFileChanged, 'adev')
                nuc += file_nuc
                lt += prevLOC
                ...
                if num_files == 0:
                    ...
                    avg_nddev = nddev/num_files
                    avg_nadev = nadev/num_files
                    avg_ncomm = ncomm/num_files
                ...
                setattr(prevFileChanged, 'adev', adev)
                ...
                x.append(nddev) # numder of developer committed weighied by number of time they were committed
                x.append(ncomm) # numder of neighbouring commits weighied by number of time they were committed
                x.append(sum(adev.values())) # ADEV
                x.append(nadev) # NADEV
                x.append(avg_nddev) #weighted average nddev
                x.append(avg_nadev) #weighted average nadev
                x.append(avg_ncomm) #weighted average ncomm
                ...
                fileObject = CommitFile(fileName, fileLa - fileLd, authors, unixTimeStamp, {author:fileLa},co_commited_files,{author:1})
        ...
        for commit in commitList:
            ...
            for propValue in prettyInfo:
                ...
                if props[0] == 'commit_hash':
                    ...
                    _commit_hash = _commit_hash.split('"')[0]
                for prop in props:
